...
**Access from your machine:** Render private services are not reachable from the internet. Use **Web Shell** in the Dashboard to run `mongosh`. For a GUI (e.g. Studio 3T) use MongoDB Atlas or a local MongoDB for development.
